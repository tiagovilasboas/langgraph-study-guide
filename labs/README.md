# Exercícios e laboratórios salvos

Esta pasta guarda versões autorais dos exercícios que praticamos durante o curso da IBM na Coursera. Cada arquivo registra o que foi construído e o aprendizado principal sem reproduzir o notebook original.

| Arquivo | Prática | Estado |
|---|---|---|
| `01-fluxo-com-estado.md` | LangGraph 101 | concluído no laboratório |
